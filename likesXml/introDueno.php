  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
      <ul class="nav navbar-nav">
        <li ><a href="./">Bienvenido <?php echo $_SESSION['session_username'];?><span class="sr-only">(current)</span></a> </li>
      </ul>
            ...
            <form id="frm-comment">
                ...
                <div class="input-row">
                    <textarea class="input-field" type="text" name="comment"
                              id="comment" placeholder="Agregar tu comentario">  </textarea>
                </div>
                <div>
