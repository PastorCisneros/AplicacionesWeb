...
header("Location: introAdministrador.php");
}
...
if(!empty($_POST['usuarioAdministrador']) && !empty($_POST['claveAdministrador'])) {
    ...
    $consulta =mysqli_query($conn,"SELECT * FROM usuarios WHERE usuarioAdministrador='".$usuarioAdministrador."' AND claveAdministrador='".$claveAdministrador."' AND administrador=1 ");
...
<img class="img-responsive" alt="iamgurdeeposahan" src="img/admin.png" style="width: 71px; border-radius: 43px;">
